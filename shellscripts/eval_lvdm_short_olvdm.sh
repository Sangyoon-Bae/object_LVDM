...
DATACONFIG="/global/cfs/projectdirs/m4244/stella/object_LVDM/configs/lvdm_short/sky_olvdm.yaml"
FAKEPATH='/global/cfs/projectdirs/m4244/stella/object_LVDM/results/OLVDM_whole/OLVDM_whole.npy'
